...
CREATE TABLE `uye` (
  ...
  `sifre` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
INSERT INTO `uye` VALUES ('Fatma','Tanrıkulu',1,'k','fatma@gmail.com','fatma','5555555555'),('Semih','Durmaz',2,'e','semih@hotmail.com','semih','5343842144'),('Hatice','Demir',3,'k','hatice@windowslive.com','hatice','5263485654'),('Ayhan','Aliyev',4,'e','ayhan@yahoo.com','ayhan','5462545785'),('Göksel','Biricik',5,'e','goksel@hotmail.com','goksel','5421523262'),('Akasya','Kılıç',6,'k','akasya@gmail.com','akasya','5875478596');
